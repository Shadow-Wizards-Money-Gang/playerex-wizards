...
public final class ExAPI {
	...
	public static final CacheableValue<Integer> LEVEL_VALUE = OfflinePlayerCache
			.register(new com.github.clevernucleus.playerex.impl.LevelValue());
	/** The Cardinal Components Key for PlayerEx player data. */
	public static final ComponentKey<PlayerData> PLAYER_DATA = ComponentRegistry
			.getOrCreate(new Identifier(MODID, "player_data"), PlayerData.class);
	/** The Cardinal Components Key for PlayerEx experience data. */
	public static final ComponentKey<ExperienceData> EXPERIENCE_DATA = ComponentRegistry
			.getOrCreate(new Identifier(MODID, "experience_data"), ExperienceData.class);
	 ...
	 * distance attribute.
	 */
	public static final EntityAttributeSupplier REACH_DISTANCE = EntityAttributeSupplier
			.of(new Identifier("reach-entity-attributes:reach"));
	/**
	 * If JamieWhiteShirt reach-entity-attributes exist then this accesses the
	 * attack range attribute.
	 */
	public static final EntityAttributeSupplier ATTACK_RANGE = EntityAttributeSupplier
			.of(new Identifier("reach-entity-attributes:attack_range"));

	/**
	 * PlayerEx config access. Yes I know, AutoConfig on the server too?? Ewww. It
	 * works it is fine.
	 */
