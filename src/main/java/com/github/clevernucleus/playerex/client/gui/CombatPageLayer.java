...
public class CombatPageLayer extends PageLayer {
	...
	static {
		...
		COMPONENTS.add(RenderComponent.of(ExAPI.RANGED_CRIT_DAMAGE, value -> {
			...
			tooltip.add((Text.translatable("playerex.gui.page.combat.tooltip.ranged_crit_damage[0]"))
					.formatted(Formatting.GRAY));
			tooltip.add((Text.translatable("playerex.gui.page.combat.tooltip.ranged_crit_damage[1]"))
					.formatted(Formatting.GRAY));
